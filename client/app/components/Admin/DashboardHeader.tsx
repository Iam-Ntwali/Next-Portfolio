  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0 z-[9999999]">
      ...
      >
        ...
        <span className="absolute -top-2 -right-2 bg-[#f47400] rounded-full w-[20px] h-[20px] text-[12px] flex items-center justify-center text-white font-Poppins">
      ...
      {open && (
        <div className="w-[350px] h-[60vh] overflow-y-scroll py-3 px-2 border border-[#ffffff0c] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-[1000000000] rounded">
          <h5 className="text-center text-[18px] font-Poppins text-black dark:text-white p-3">
            Notifications
          </h5>
          {notifications &&
